...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.legacyCaptureCheckBox.setGeometry(QtCore.QRect(8, 271, 100, 20))
        ...
        self.legacyCaptureCheckBox.raise_()
...
"Default value"))
        ...
        self.legacyCaptureCheckBox.setToolTip(_translate("MainWindow", "<html><head/><body><p>Legacy capture may result in higher max FPS, but will likely not support hardware accelerated regions.</p></body></html>"))
